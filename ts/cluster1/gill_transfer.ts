import {
  ...
  import { buildTransferTokensTransaction } from "gill/dist/programs/token/index";
  import { loadKeypairSignerFromEnvironment } from "gill/dist/node/index";
...
//   dotenv.config();
  ...
  async function main() {
    ...
    try {
      ...
      const signedTx = await signTransactionMessageWithSigners(transferTx, signer);
